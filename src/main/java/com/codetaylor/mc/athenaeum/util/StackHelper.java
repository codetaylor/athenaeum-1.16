...
public final class StackHelper {
  ...
  /**
   * Returns an item stack's {@link CompoundNBT}. If the stack is empty,
  ...
  public static <T extends TileEntity> T readTileEntityFromItemStack(T tile, BlockState blockState, ItemStack itemStack) {

    CompoundNBT tagCompound = itemStack.getTag();

    if (tagCompound != null) {
      CompoundNBT tileCompound = tagCompound.getCompound(BLOCK_ENTITY_TAG);
      tile.read(blockState, tileCompound);
    }
